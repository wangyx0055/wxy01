        ...
        if(data.success){
            ...
            for(var i = 0;i<5;i++) {
                if(i==0){
                    ...
                    re_div+='<p>工单管理</p>';
                    re_div+='</div>';
                    re_div+='<input type="checkbox" style="margin-left: 8px" class="input" name="add'+list[i].id+'" disabled="disabled" id="29" value="29" /><span >授权工单</span>';
                    re_div+='<input type="checkbox" class="input"   name="add'+list[i].id+'" disabled="disabled" id="30" value="30" disabled="disabled" /><span >工单审批</span>';
                    re_div+='<hr >';
                    re_div+='<div class="mch">';
                    re_div+='<p>统计分析</p>';
                    re_div+='</div>';
                    ...
                    re_div+='<input type="checkbox" class="input"   name="add'+list[i].id+'" disabled="disabled" id="26" value="26"/><span >应用运维</span>';
                    re_div+='<hr >';
                    re_div+='<div class="mch">';
                    re_div+='<p>密码管理</p>';
                    re_div+='</div>';
                    ...
                    re_div+='</div>';
                    re_div+='<input type="checkbox" style="margin-left: 8px" class="input" name="add'+list[i].id+'" disabled="disabled" id="29" value="29" /><span >授权工单</span>';
                    re_div+='<input type="checkbox" class="input"   name="add'+list[i].id+'" disabled="disabled" id="30" value="30" /><span >工单审批</span>';
                    re_div+='<hr >';
                    re_div+='<div class="mch">';
                    re_div+='<p>统计分析</p>';
                    re_div+='</div>';
            ...
            for(var i = 5;i<list.length;i++) {
                ...
                re_div+='<p>工单管理</p>';
                re_div+='</div>';
                re_div+='<input type="checkbox" style="margin-left: 8px" class="input" name="add'+list[i].id+'"   id="29" value="29" /><span >授权工单</span>';
                re_div+='<input type="checkbox" class="input"   name="add'+list[i].id+'" id="30" value="30" /><span >工单审批</span>';
                re_div+='<hr >';
                re_div+='<div class="mch">';
                re_div+='<p>统计分析</p>';
                re_div+='</div>';
