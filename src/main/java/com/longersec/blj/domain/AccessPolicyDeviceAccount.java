...
public class AccessPolicyDeviceAccount {
	...
	public AccessPolicyDeviceAccount() {
		super();
	}
	...
	public String toString() {
		return "AccessPolicyDevice [policy_id=" + policy_id + ", device_account_id=" + device_account_id + "]";
	}
