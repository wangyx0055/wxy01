            ...
            <div class="box-body" style="margin-top: -22px">
               <div class="input-group margin">
                ...
                <div id="div1" style="display:none;font-size: 13px">
                  ...
                  <span style="margin-left: 144px">起始申请时间:</span>
                  </div>
                  <div>
                  ...
                  <input type="date" placeholder="&nbsp;&nbsp;&nbsp;请输入起始申请日期" style="margin-top: 4px;width: 180px;height: 28px;border-radius: 3px;border: 1px solid #ccc;font-size: 12px;color: #ccc;margin-left: 20px ">
                </div>
                 <div style="margin-top: 8px">
                  ...
                  <input type="date" placeholder="&nbsp;&nbsp;&nbsp;请输入起始运维时间" style="margin-top: 4px;width: 180px;height: 28px;border-radius: 3px;border: 1px solid #ccc;font-size: 12px;color: #ccc;margin-left: 20px ">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-primary" style="float: left;margin-left:420px;height: 30px;color: #fff;font-size: 12px;margin-top: -10px" data-toggle="modal" data-target="#" data-dismiss="modal">确定</button>
