        ...
        <div class="col-xs-12">
          <div class="box" style="box-shadow: none;border-top: none">
            <div class="box-header">
              ...
              <li style="float: left;"><div style="margin-top: 3px"><span style="font-size: 17px;;margin-left: -10px;">审计查询&nbsp;&nbsp;&nbsp;</span></div></li>
              ...
              <table id="example2" class="table table-bordered table-hover" style="font-size: 12.5px">
                <thead>
                       <tr>
                        ...
                        <th><span style="font-size: 14px;font-weight: lighter;margin-left: 75px">操作</span></th>
                       </tr>
                    </thead>
                    <tbody>
                      <tr>
                  ...
                  <div class="modal-body" style="height: 380px">
                     ...
                     <br>
                      <div class="modal-footer">
                       <button type="button" class="btn btn-primary" style="float: left;margin-left:410px;height: 30px;color: #fff;font-size: 12px"  data-dismiss="modal">确定</button>
